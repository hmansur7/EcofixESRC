...
urlpatterns = [
    ...
    path('api/admin/events/<int:id>/', AdminRemoveEventView.as_view(), name='admin-remove-event'),
    path('api/admin/events/<int:id>/registrations/', AdminEventRegistrationsView.as_view(), name='admin-event-registrations'),
